    ...
    <section className="bg-sky-100">
      <div className="mx-auto max-w-7xl flex flex-col gap-6 mt-8">
        ...
        <article className="grid md:grid-cols-2 sm:grid-cols-1 gap-6">
          <div className="bg-white border-2 border-slate-500 rounded-xl p-4 w-full shadow-xl flex flex-col justify-center align-center items-center">
            ...
            <div className="bg-white px-8 py-4 rounded-xl border-2 border-slate-500 w-3/4 m-auto">
              {" "}
              <img
                src={defaultImg.img}
                alt="Greg Barker"
